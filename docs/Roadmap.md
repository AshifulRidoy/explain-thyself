...
| **M3 Explorer on fixtures** | `/explore` fixture mode: TraceCanvas + node registry, Inspector with taxonomy badges, TokenStream, EntropyMeter, ProbabilityDistribution, LayerActivityPanel, ⌘K palette | python-rust fixture plays end-to-end; every number matches the fixture JSON; mobile stacks | 🔜 next |
